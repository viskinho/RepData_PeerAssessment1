...
##colnames(dailyStepsy) <- c("TotalSteps")
##View(dailyStepsy)
...
```
##### 1. Plot the number days a certain numer of days was taken (histogram)
```{r}
##qplot(dailyStepsy, 
##      xlab='Steps per day', 
##      ylab='Frequency per 1500', 
##      fill = '#003A6F',
##      binwidth=1500)
COFBlue <- '#003A6F'
ggplot(stepsPerDay, aes(x = steps)) + 
    ...
    theme_bw() +
    theme(text=element_text(size=16, family="Ariel"))
